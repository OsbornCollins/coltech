...
func (app *application) registerUserHandler(w http.ResponseWriter, r *http.Request) {
	// Hold date from the request body
	var input struct {
	...
	// Add permissions for newly created user
	err = app.models.Permissions.AddForUser(user.ID, "coltech_items:read")
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
...
func (app *application) activateUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Get the user details of the provided token or give the client
	// feedback about and invalid token
	...
	// Delete the users token that was used for activation
